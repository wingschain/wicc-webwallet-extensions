...
const BAAS_TESTNET = 'https://baas-test.wingschain.cc/v2/api'  // 'http://10.0.0.31:21052' //             'https://test.wiccbaas.com/v1/api'
const BAAS_MAINNET = 'https://baas.wingschain.cc/v2/api'
