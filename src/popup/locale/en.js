export default {
  ...
  wallet: {
    create: {
      ...
      password: {
        title: 'Set Password',
        tip: 'WingsChain doesn\'t store your wallet password and can\'t help you get it back, so keep it in mind.',
        password: 'Password',
        passwordPlaceholder: 'Please enter 6~20 characters',
  ...
  setting: {
    ...
    about: {
      ...
      name: 'WingsMax',
      links: 'Links',
      homepage: 'WingsChain Offical Website',
      devCenter: 'WingsChain Developer Portal'
    },
    password: {
