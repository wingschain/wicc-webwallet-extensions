...
export default {
  ...
  methods: {
    ...
    fixed: fixed,
    scanHost(str) {
      //https://testnet.Wingsscan.com/#/address/
      //https://www.Wingsscan.com/#/address/
      //https://testnet.Wingsscan.com/#/txhash/
      //https://www.Wingsscan.com/#/txhash/
      if (this.network === 'testnet' || this.myselfNetWork) {
        if (str.length === 34) {
          return 'https://testnet.Wingsscan.com/#/address/'
        } else {
          return 'https://testnet.Wingsscan.com/#/txhash/'
        }
      }
      if (this.network === 'mainnet' || (!this.network && !this.myselfNetWork)) {
        if (str.length === 34) {
          return 'https://www.Wingsscan.com/#/address/'
        } else {
          return 'https://www.Wingsscan.com/#/txhash/'
        }
      }
    },
    isDEX(type) {
